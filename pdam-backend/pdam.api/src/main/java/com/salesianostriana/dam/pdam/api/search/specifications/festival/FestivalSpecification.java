...
@Log
@AllArgsConstructor
public class FestivalSpecification implements Specification<Festival> {

    private SearchCriteria searchCriteria;


    @Override
    public Predicate toPredicate(Root<Festival> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
