...
@Log
@AllArgsConstructor
public class DiscothequeSpecification implements Specification<Discotheque> {

    private SearchCriteria searchCriteria;


    @Override
    public Predicate toPredicate(Root<Discotheque> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
