...
insert into city (id, name, location) values (9,'Burgos', '42,34113004/-3,70419805');
insert into city (id, name, location) values (10,'Cáceres', '39,47316762/-6,37121092');
insert into city (id, name, location) values (11,'Cádiz', '36,52171152/-6,28414575');
insert into city (id, name, location) values (12,'Cantabria', '43,46297885/-3,80474784');
insert into city (id, name, location) values (13,'Castellón', '39,98640809/-0,03688142');
insert into city (id, name, location) values (14,'Ceuta', '35,88810209/-5,30675127');
insert into city (id, name, location) values (15,'Ciudad Real', '38,98651781/-3,93131981');
...
insert into city (id, name, location) values (29,'La Rioja', '42,46644945/-2,44565538');
insert into city (id, name, location) values (30,'Lugo', '43,0091282/-7,55817392');
insert into city (id, name, location) values (31,'Madrid', '40,40841191/-3,68760088');
insert into city (id, name, location) values (32,'Málaga', '36,72034267/-4,41997511');
insert into city (id, name, location) values (33,'Melilla', '35,294731/-2,942281');
insert into city (id, name, location) values (34,'Murcia', '37,98436361/-1,1285408');
insert into city (id, name, location) values (35,'Navarra', '42,814102/-1,6451528');
insert into city (id, name, location) values (36,'Ourense', '42,33654919/-7,86368375');
insert into city (id, name, location) values (37,'Oviedo', '43,36232165/-5,84372206');
insert into city (id, name, location) values (38,'Palencia', '42,0078373/-4,53460106');
insert into city (id, name, location) values (39,'Pontevedra', '42,43381442/-8,64799018');
insert into city (id, name, location) values (40,'Salamanca', '40,96736822/-5,66538084');
insert into city (id, name, location) values (41,'Santa Cruz de Tenerife', '28,462854082/-16,247206286');
insert into city (id, name, location) values (42,'Segovia', '40,9498703/-4,12524116');
insert into city (id, name, location) values (43,'Sevilla', '37,38620512/-5,99251368');
insert into city (id, name, location) values (44,'Soria', '41,76327912/-2,46624798');
insert into city (id, name, location) values (45,'Tarragona', '41,11910287/1,2584219');
insert into city (id, name, location) values (46,'Teruel', '40,34412951/-1,10927177');
insert into city (id, name, location) values (47,'Toledo', '39,85715187/-4,02431421');
insert into city (id, name, location) values (48,'Valencia', '39,47534441/-0,37565717');
insert into city (id, name, location) values (49,'Valladolid', '41,65232777/-4,72334924');
insert into city (id, name, location) values (50,'Vizcaya', '43,25721957/-2,92390606');
...
insert into user_entity (full_name, user_name, email, id, phone_number, password, img_path, verified, account_non_expired, account_non_locked, credentials_non_expired, enabled, created_at, last_password_change_at, roles, authorized, city, gender) values ('Solomón García', 'ferxxo', 'ferxxo@gmail.com', '74002906-c609-5b6b-9acf-177f11e48261', '158878439', '{bcrypt}$2a$10$fep2rjFYeLmppZBXDWA1TuwRY0qpkrA2dKDH8eBB1.xOGUmfpbelm', 'default.jpeg', true, true, true, true, true, '2022-12-04', '2022-05-07', 'USER, VERIFIED, ADMIN', false, 44, 63); --Estuche39_
...
insert into event (dtype, id, name, location, city, capacity, date_time, duration, price, drink_included, number_of_drinks, adult, type, popularity, img_path, description) values ('Festival', 71, 'Fatz', '-16.4359692/-71.6050339', 6, 10000, '2023-06-13', 3, 112, false, 0, false, 'FESTIVAL', 0, 'default-events.png', 'Fiesta loca');
insert into event (dtype, id, name, location, city, capacity, date_time, duration, price, drink_included, number_of_drinks, adult, type, popularity, img_path, description) values ('Festival', 72, 'LiveZ', '50.2124156/36.1590565', 7, 14000, '2023-08-01', 3, 21, false, 0, true, 'FESTIVAL', 0, 'default-events.png', 'Fiesta loca');
insert into event (dtype, id, name, location, city, capacity, date_time, duration, price, drink_included, number_of_drinks, adult, type, popularity, img_path, description) values ('Festival', 73, 'Camimbo', '22.672099/113.250897', 8, 12200, '2023-08-24', 1, 5, true, 4, true, 'FESTIVAL', 0, 'default-events.png', 'Fiesta loca');
insert into event (dtype, id, name, location, city, capacity, date_time, duration, price, drink_included, number_of_drinks, adult, type, popularity, img_path, description) values ('Festival', 74, 'Ntag', '19.7633057/96.0785104', 9, 11200, '2023-07-01', 5, 76, true, 4, false, 'FESTIVAL', 0, 'default-events.png', 'Fiesta loca');
insert into event (dtype, id, name, location, city, capacity, date_time, duration, price, drink_included, number_of_drinks, adult, type, popularity, img_path, description) values ('Festival', 75, 'Rhyloo', '41.44056/22.72778', 10, 5000, '2023-07-05', 3, 148, true, 2, false, 'FESTIVAL', 0, 'default-events.png', 'Fiesta loca');
