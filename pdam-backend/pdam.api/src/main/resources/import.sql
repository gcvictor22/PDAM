...
insert into user_entity (full_name, user_name, email, id, phone_number, password, img_path, verified, account_non_expired, account_non_locked, credentials_non_expired, enabled, created_at, last_password_change_at, roles, authorized, city, gender) values ('Solomón García', 'ferxxo', 'gcvictor22@gmail.com', '74002906-c609-5b6b-9acf-177f11e48261', '158878439', '{bcrypt}$2a$10$fep2rjFYeLmppZBXDWA1TuwRY0qpkrA2dKDH8eBB1.xOGUmfpbelm', 'default.jpeg', true, true, true, true, true, '2022-12-04', '2022-05-07', 'USER, VERIFIED', false, 44, 63); --Estuche39_
