...
insert into user_entity (full_name, user_name, email, id, phone_number, password, img_path, verified, account_non_expired, account_non_locked, credentials_non_expired, enabled, created_at, last_password_change_at, roles, authorized, city) values ('Rhoda Blayney', 'rblayney0', 'rblayney0@shinystat.com', '1de440c9-6c02-5d77-8586-bc6a7ad216ed', '984113814', '{bcrypt}$2a$10$cPOngwJ8p10s6iUrR17cIuiy.JsKCJe6h8ql569SzeswYM8jPPjW2', 'default.png', false, true, true, true, true, '2022-07-20', '2022-10-26', 'USER', false, 23); --THoGYvZF9Vh.
insert into user_entity (full_name, user_name, email, id, phone_number, password, img_path, verified, account_non_expired, account_non_locked, credentials_non_expired, enabled, created_at, last_password_change_at, roles, authorized, city) values ('Mack Antonoyev', 'mantonoyev1', 'mantonoyev1@google.es', '8ee56ea7-ce36-595c-bfb4-b5fd87e34b09', '973145646', '{bcrypt}$2a$10$ApSMXPShH3jBFbPT.K9FyeesyyivT4udGyVIh3WccMn9ibNLF9Tge', 'default.png', false, true, true, true, true, '2022-03-01', '2022-07-17', 'USER', false, 31); -- KYKvrVgd2.
insert into user_entity (full_name, user_name, email, id, phone_number, password, img_path, verified, account_non_expired, account_non_locked, credentials_non_expired, enabled, created_at, last_password_change_at, roles, authorized, city) values ('Aldon Whitsey', 'awhitsey2', 'awhitsey2@ox.ac.uk', 'df442a4d-2ec0-54b6-ab24-019787533d25', '469989018', '{bcrypt}$2a$10$u/S0IIP0gLEAwREvxIhN4ejItaagYHT.tVdXFDTNOy.1ylpNpCtBO', 'default.png', false, true, true, true, true, '2022-05-12', '2022-06-25', 'USER', false, 28); --Rf9j1QmhQY.
insert into user_entity (full_name, user_name, email, id, phone_number, password, img_path, verified, account_non_expired, account_non_locked, credentials_non_expired, enabled, created_at, last_password_change_at, roles, authorized, city) values ('Alica Dederick', 'adederick3', 'adederick3@indiegogo.com', 'f2691563-173b-522f-8a25-599c1fcc7772', '757538186', '{bcrypt}$2a$10$dv0CLXH26HwzBgslsSY6K.IZzQSuqPUzLGE/CzuyzUM8EqJLyq/tm', 'default.png', false, true, true, true, true, '2023-01-29', '2022-04-15', 'USER', false, 11); --K75UZOdc.
insert into user_entity (full_name, user_name, email, id, phone_number, password, img_path, verified, account_non_expired, account_non_locked, credentials_non_expired, enabled, created_at, last_password_change_at, roles, authorized, city) values ('Goldia Sturley', 'gsturley4', 'gsturley4@sogou.com', '65d4b372-12b6-5167-8d2c-1b797fdf3b74', '536914860', '{bcrypt}$2a$10$2D95SuKcSRktx5WyIXsGuupCXJXIsVftsSPTtgx0KkDHL8bHh7sYC', 'default.png', false, true, true, true, true, '2022-07-18', '2022-09-02', 'USER', false, 9); --9roQQv5to.
insert into user_entity (full_name, user_name, email, id, phone_number, password, img_path, verified, account_non_expired, account_non_locked, credentials_non_expired, enabled, created_at, last_password_change_at, roles, authorized, city) values ('Melisse Gatiss', 'mgatiss5', 'mgatiss5@live.com', '9cc870e3-adb0-5e8e-ac2a-cfccf662f175', '889772243', '{bcrypt}$2a$10$iMMFtrWiVGlTiziXWQE4J.kcbRn8YneYc53VC8B68seerCljMicC.', 'default.png', false, true, true, true, true, '2022-12-20', '2023-02-04', 'USER', false, 34); --mZIeSiz.9
insert into user_entity (full_name, user_name, email, id, phone_number, password, img_path, verified, account_non_expired, account_non_locked, credentials_non_expired, enabled, created_at, last_password_change_at, roles, authorized, city) values ('Carlie Scragg', 'cscragg6', 'cscragg6@redcross.org', 'd8f6dc83-b45a-5e24-9baa-18c29a9e6e50', '247910588', '{bcrypt}$2a$10$Q0GliOSQccmBKYfdHePiMutLSBJIzYczOcSZ1ZNSovDbP3Qr3BrGe', 'default.png', false, true, true, true, true, '2022-10-28', '2022-03-14', 'USER', false, 2); --9JYFWukND.
insert into user_entity (full_name, user_name, email, id, phone_number, password, img_path, verified, account_non_expired, account_non_locked, credentials_non_expired, enabled, created_at, last_password_change_at, roles, authorized, city) values ('Jenda Frichley', 'jfrichley7', 'jfrichley7@apple.com', '62a17769-cc2b-5c2a-bc1a-9e76911e999b', '889574986', '{bcrypt}$2a$10$QhNubUOiyOgPVTI/oOgnLeM7nP4bPiCbLbpHzlDjqySTYx6AmNKuK', 'default.png', false, true, true, true, true, '2022-11-07', '2022-06-18', 'USER', false, 48); --KQHohyMe.1
insert into user_entity (full_name, user_name, email, id, phone_number, password, img_path, verified, account_non_expired, account_non_locked, credentials_non_expired, enabled, created_at, last_password_change_at, roles, authorized, city) values ('Andi Stolz', 'astolz8', 'astolz8@epa.gov', 'e55c3744-0875-5044-bb2c-c9fd761af605', '602630465', '{bcrypt}$2a$10$84/WH4qo4DgulW3XzrcTduod0cOnUSiISYd0vgHrb5j5/IrgtGhi2', 'default.png', false, true, true, true, true, '2022-10-17', '2022-08-29', 'USER', false, 35); --I2twy6v.
insert into user_entity (full_name, user_name, email, id, phone_number, password, img_path, verified, account_non_expired, account_non_locked, credentials_non_expired, enabled, created_at, last_password_change_at, roles, authorized, city) values ('Solomón García', 'ferxxo', 'ferxxo@gmail.com', '74002906-c609-5b6b-9acf-177f11e48261', '158878439', '{bcrypt}$2a$10$fep2rjFYeLmppZBXDWA1TuwRY0qpkrA2dKDH8eBB1.xOGUmfpbelm', 'default.png', true, true, true, true, true, '2022-12-04', '2022-05-07', 'USER, VERIFIED', false, 44); --Estuche39_
...
alter sequence hibernate_sequence restart with 63