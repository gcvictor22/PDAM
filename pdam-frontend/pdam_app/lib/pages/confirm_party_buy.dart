...
import 'package:pdam_app/blocs/confirm_party_buy/confirm_party_buy_bloc.dart';
...
class ConfirmPartyBuyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => ConfirmPartyBuyBloc(_eventService, stripeId),
...
class _ConfirmPartyBuyPageSFState extends State<ConfirmPartyBuyPageSF> {
  @override
  Widget build(BuildContext context) {
    final formBloc = context.read<ConfirmPartyBuyBloc>();
    return FormBlocListener<ConfirmPartyBuyBloc, String, String>(
...
class ConfirmPartyBuyWidget extends StatefulWidget {
  final ConfirmPartyBuyBloc formBloc;
