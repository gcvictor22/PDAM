...
import 'package:pdam_app/blocs/buy_party/buy_party_bloc.dart';
...
class BuyPartyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => BuyPartyBloc(_eventService, id),
...
class _BuyPartyPageSFState extends State<BuyPartyPageSF> {
  @override
  Widget build(BuildContext context) {
    final formBloc = context.read<BuyPartyBloc>();
    return FormBlocListener<BuyPartyBloc, String, String>(
